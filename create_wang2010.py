...
for i in range(271):
    ...
    for j in range(271):
        ...
        if  float(line[j]) !=  0 and i != j :  #排除自己与自己的相似性
            ...
            print(string1)
            string_all += string1 + '\n'
fh = open('wang2010_miRNA_for_HMDDv3.2/misimv1.0_association.txt', 'w', encoding='utf-8')
fh.write(string_all)
fh.close()

path4 = 'wang2010_miRNA_for_HMDDv3.2/misimv1.0_association.txt'
...
fh = open('wang2010_miRNA_for_HMDDv3.2/smi_association_forHMDDv3.2.txt', 'w', encoding='utf-8')
